...
// import "./bubble.css";
import clipboard_project from "../../../images/Projects/digitalClipboard.png";
...
export default function BubbleGrid() {
  ...
  const centerBubble = () => {
    ...
    const centerElement = itemsRef.current.find(
      (item) => item && item.id === "center"
    );
    ...
    if (centerElement) {
      ...
      containerRef.current.scrollLeft =
        rect.left - dimensions.width / 2 + rect.width / 2;
      containerRef.current.scrollTop =
        rect.top - dimensions.height / 2 + rect.height / 2;
    }
  };
