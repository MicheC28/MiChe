...
import model_error from "../../images/Projects/Model_Errors.png";
import windsor from "../../images/Projects/windsor.jpeg";
    ...
    <div className="relative z-10 flex flex-col gap-5">
      ...
      <div className="mx-10 md:mx-40 bg-black/60 rounded-xl flex flex-col justify-evenly items-center gap-y-5 p-8">
        ...
        <ul className="text-white text-base list-disc md:mx-30">
          <li>
            Trained a Random Forest Regression and Linear Regression machine
            learning models using Pandas and Scikit-learn libraries to predict
            Windsor housing prices given its attributes with an MAE of $14,000.
          </li>
          <li>Used Panads to read data in a CSV file into a DataFrame.</li>
          <li>
            Split over 500 data entries into training and validation data.
          </li>
        </ul>
        ...
        <p className="text-white text-base md:mx-30">
          The Windsor Housing Prediction Model uses the Random Forest Regression
          and Linear Regression machine learning models from scikit-learn
          trained on historical windsor housing data to predict house prices
          given attributes like lotsize, number of bedrooms/bathrooms/garages,
          and number of stories.<br></br>
          <br></br>
          The Python script also calculates the mean absolute error to quantify
