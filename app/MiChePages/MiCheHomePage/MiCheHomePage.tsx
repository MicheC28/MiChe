...
import minis from "../../images/MiChe/MiChe_Mini_All.jpg";
import cityofroses from "../../images/MiChe/MiChe_CityOfRoses.jpg";
import iteration1 from "../../images/MiChe/MiChe_Iteration1_Wall-Mount.jpg";
import tempinst from "../../images/MiChe/MiChe_Temporary-Instance.jpg";
...
export default function MiCheHomePage() {
  ...
  return (
    <div className="z-10 relative flex flex-col gap-y-5">
      ...
      <div className="mx-10 md:mx-40 bg-black/60 flex flex-col gap-y-5 p-8 justify-evenly items-center rounded-xl">
        <p className="text-xl text-rose-300 font-bold">MiChe Art Collection</p>
        {/* <img className="w-20 rounded-xl" src={micheLogo} /> */}

        <p className="text-white text-base">
          A vibrant haven where the canvas comes alive with an explosion of
          colors and the enchanting beauty of blossoms. Immerse yourself in a
          world where every stroke is a dance of hues, and each piece tells a
          unique story of emotions and expressions. All pieces by me, Michelle.
        </p>

        <img
          src={colourvision}
          className="md:w-2/5 rounded-xl border-6 border-rose-300"
        />
      ...
      <div className="mx-10 md:mx-40 bg-black/60 rounded-xl flex md:flex-row flex-col gap-5 p-8 flex-wrap justify-center">
        {paintings.map((painting) => (
          ...
          >
            ...
            {painting.type == "Collection" ? (
              <a
                className="p-3 bg-rose-900 rounded-xl text-center text-rose-300 font-bold hover:cursor-pointer hover:bg-rose-950 transition duration-300"
                href={painting.link}
              >
                View Collection
              </a>
